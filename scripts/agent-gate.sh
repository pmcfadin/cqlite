...
#                      the non-vacuity proof for the pub-surface component. 35 cases,
...
# the pub-surface component: 35 cases driving scripts/ci/check-pub-surface.sh through
# 8 greens, 25 reds, the usage case and the kill-safety case, substituting the artifact
