...
#                      the non-vacuity proof for the pub-surface component. 41 cases,
...
# the pub-surface component: 41 cases driving scripts/ci/check-pub-surface.sh through
# 9 greens, 30 reds, the usage case and the kill-safety case, substituting the artifact
