...
#                      the non-vacuity proof for the pub-surface component. 40 cases,
...
# the pub-surface component: 40 cases driving scripts/ci/check-pub-surface.sh through
# 9 greens, 29 reds, the usage case and the kill-safety case, substituting the artifact
