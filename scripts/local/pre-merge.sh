...
DATASET_ASSET="${DATASET_ASSET:-cassandra5-small-full-v3.4.tar.gz}"
DATASET_SHA256="${DATASET_SHA256:-3cae644360e0142a6bb5e96ddab445ff18e3478e7058104842ce1a455fba8a33}"
