...
# review round 1).
#
# One file of the rig's self-test set, beside test_ws0_report_guards.sh (the reporter's
# fail-closed paths) and test_ws0_cpu_pinning_guards.sh (the measurement apparatus), for
# one subject:
#
...
#
# WHAT IS NOT HERE, and why. The MEASUREMENT-PROVENANCE subject — "a report must identify
# the BYTES and the CONFIGURATION it describes" — moved to
# `scripts/tests/test_ws0_provenance_guards.sh` under the campsite rule (#3272 review round
# 6): the corpus-identity BYTE verification (B6), the COMPLETE component set (F3), the
# pre-measurement corpus PIN (round 4) and the manifest-read configuration (F1). That is a
# property of the RUN rather than of a NUMBER, and it is orthogonal to this file's subject —
# every check here is satisfiable by an artifact set that is internally consistent about the
# WRONG run, which is exactly why the two are separate suites.
#
...
# --------------------------------------------------------------------------
# Fixture builders — SHARED with test_ws0_round_metadata.sh and
# test_ws0_provenance_guards.sh
# --------------------------------------------------------------------------
...
# The MEASUREMENT-PROVENANCE subject — the corpus identity's bytes, the complete component
...
NO_ERR_KEY='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
BAD_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":"none","requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
REAL_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":4,"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
# validly observed.
NEG_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":-3,"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
NEG_ROWS='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":-1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
NEG_RPS='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":-250000.0,"duration_s":4.0}'
...
for bad in Infinity NaN; do
  d="$TMP/nonfinite-$bad"
  make_session "$d" "{\"schema\":\"flight-loadgen.step/v1\",\"step\":0,\"target_concurrency\":1,\"shape\":\"full\",\"round\":\"__TAG__\",\"endpoint\":\"__ENDPOINT__\",\"requests_ok\":1,\"requests_error\":0,\"error_codes\":{},\"requests_unavailable\":0,\"rows_total\":1000,\"bytes_total\":$WS0_PREFLIGHT_BYTES_PER_SCAN,\"rows_per_s\":$bad,\"duration_s\":4.0}"
...
ZERO_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
scan_payload() { # scan_payload <dir> <rows_denom> <secs> <passes-json>
  local d="$1"
  mkdir -p "$d"
  printf '{ '"$WS0_SCAN_FIXED"', '"$(ws0_scan_session_bound "${WS0_SCAN_CORPUS:-$TMP/corpus}")"', "rows_denominator": %s, "timed_scan_secs": %s, "setup_secs": 0.5, "passes": %s }\n' \
...
printf '{ '"$WS0_SCAN_FIXED"', '"$(ws0_scan_session_bound "${WS0_SCAN_CORPUS:-$TMP/corpus}")"', "rows_denominator": 1000, "timed_scan_secs": 2.0, "setup_secs": 0.5 }\n' > "$d/scan-warm-1.json"
perf_csv "$d/perf-scan-warm-1.csv" 2000000 4000000
perf_csv "$d/perf-scan-warm-1-setup.csv" 100000 200000
printf 'ok\n' > "$d/scan-warm-1.prewarm.status"
make_round "$d" "scan-warm-1" 1 1
...
SHED='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":37,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
NO_SHED_KEY='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
for bad_shed in '-3' '0.9' 'true' '"none"'; do
  ...
  make_session "$d" "{\"schema\":\"flight-loadgen.step/v1\",\"step\":0,\"target_concurrency\":1,\"shape\":\"full\",\"round\":\"__TAG__\",\"endpoint\":\"__ENDPOINT__\",\"requests_ok\":1,\"requests_error\":0,\"error_codes\":{},\"requests_unavailable\":$bad_shed,\"rows_total\":1000,\"bytes_total\":$WS0_PREFLIGHT_BYTES_PER_SCAN,\"rows_per_s\":250.0,\"duration_s\":4.0}"
  out=$(run_report "$d" "$TMP/corpus"); rc=$?
...
UNCLASSIFIED='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0,"requests_throttled":5}'
...
# ...and EVERY VERIFYING DISPOSITION must have BOTH an expectation table AND a checker that reads it
# (#3272 round 14, F1). Asserted over the module's own registries rather than over the two names
# known when this was written: `round` was classified `required-present` — verified to EXIST and
# nothing more — and a check keyed on the two names of the day would have said nothing about it. A
# disposition whose table nobody consults is the round-12 F2 shape (the thing was done; the check on
# it was nominal), so the closure is asserted here as well as at import.
from ws0_loadgen_record import _CHECKED_DISPOSITIONS, _EXPECTATION_TABLES
for kind, (table_name, table) in _EXPECTATION_TABLES.items():
    if kind not in DISPOSITIONS:
        sys.exit(f"{table_name} states expectations for {kind!r}, which is not a recognised "
                 "disposition — no field could carry it")
    if not table:
        sys.exit(f"{table_name} is EMPTY, so {kind!r} verifies nothing while the census claims it "
                 "does")
    if kind not in _CHECKED_DISPOSITIONS:
        sys.exit(f"{kind!r} has an expectation table but NO CHECKER reads it, so a field "
                 "classified with it is verified by nothing")
for kind in _CHECKED_DISPOSITIONS:
    if kind not in _EXPECTATION_TABLES:
        sys.exit(f"{kind!r} has a checker but no expectation table to compare against")
# NON-VACUITY for that closure: a disposition NOBODY verifies must not be silently tolerated. Every
# disposition the census actually USES is either a verifying one (table + checker, above) or one of
# the two whose meaning is that nothing is compared — and those two are named, so a THIRD
# non-verifying disposition cannot be introduced without this failing. `required-present` was
# exactly such a disposition, and it is what F1 found.
NON_VERIFYING = {"consumed", "ignored"}
used = {kind for kind, _ in D.values()}
unaccounted = used - NON_VERIFYING - set(_EXPECTATION_TABLES)
if unaccounted:
    sys.exit(f"disposition(s) {sorted(unaccounted)} are used by the census but are neither "
             "verifying (an expectation table + a checker) nor one of the two whose meaning is "
             f"that nothing is compared ({sorted(NON_VERIFYING)}). `required-present` was such a "
             "disposition: it meant `verified to EXIST` and let a swapped rep JSONL through "
             "(#3272 round 14, F1)")
...
{
  printf '%s\n' '{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"ramp-1","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":9,"requests_unavailable":0,"rows_total":37,"rows_per_s":99.0,"duration_s":1.0}'
  printf '%s\n' "$GOOD_FLIGHT"
...
ZERO_RPS='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":0.0,"duration_s":4.0}'
...
FORGED_RPS='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":9999999.0,"duration_s":4.0}'
...
# results.json.
NO_DUR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0}'
...
for bad_dur in 0 0.0 -4.0 '"4s"' 'null'; do
  ...
  make_session "$d" "{\"schema\":\"flight-loadgen.step/v1\",\"step\":0,\"target_concurrency\":1,\"shape\":\"full\",\"round\":\"__TAG__\",\"endpoint\":\"__ENDPOINT__\",\"requests_ok\":1,\"requests_error\":0,\"error_codes\":{},\"requests_unavailable\":0,\"rows_total\":1000,\"bytes_total\":$WS0_PREFLIGHT_BYTES_PER_SCAN,\"rows_per_s\":250.0,\"duration_s\":$bad_dur}"
...
FRAC_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0.9,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
BOOL_ERR='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":true,"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
FRAC_OK='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1.9,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
BOOL_OK='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":true,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
FRAC_ROWS='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1,"requests_error":0,"error_codes":{},"requests_unavailable":0,"rows_total":1000.5,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
INTEGRAL_FLOAT='{"schema":"flight-loadgen.step/v1","step":0,"target_concurrency":1,"shape":"full","round":"__TAG__","endpoint":"__ENDPOINT__","requests_ok":1.0,"requests_error":0.0,"error_codes":{},"requests_unavailable":0,"rows_total":1000.0,"bytes_total":'"$WS0_PREFLIGHT_BYTES_PER_SCAN"',"rows_per_s":250.0,"duration_s":4.0}'
...
# ~92 checks and passed them exits 0 and reports SUCCESS. That is the suite-level
# `0/0` shape this whole issue is about, one level up from the checks themselves.
#
# The floor is DERIVED from the OBSERVED count, not lowered to fit: this suite ran 135 checks
# before round 6's campsite-rule split and runs 92 after it, measured by instrumenting
# `pass`/`fail` to report their own call site (135 = 92 here + 43 in
# `test_ws0_provenance_guards.sh`, so the split moved cases without dropping one). It is set
