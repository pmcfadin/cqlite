...
# ==========================================================================
# THE READER HALF LIVES IN ITS OWN SUITE
# ==========================================================================
# The layer OUT from §6 — does the REPORTER require the WRITER's record to be COMPLETE? — is
# `test_ws0_boundary_record_completeness.sh`. Split on the campsite rule when this file passed 1300
# lines against the ~1500 test target, along the SAME SEAM the shipped code follows: round 22 split
# the boundary question into a WRITER module (`ws0_corpus_bytes.py`, whose verdict this file's §1-6
# are about) and a READER module (`ws0_boundary_observations.py`, whose three refusal directions the
# new suite observes). One question per file, matching one question per module.
