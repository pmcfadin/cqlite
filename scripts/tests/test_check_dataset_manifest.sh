...
JESTSTUB
  ...
  _nbgate_measure() { # <tag>
    ...
    # that added the enumeration (694df0d90, #3642/#3867, same day 12:38 -07), so #3867's
    # branch was cut before the guard existed and never ran `tooling-tests` with it
    # present -- ordinary base staleness, not an authoring error on either side.
