...
| Issue | P | Finding |
|---|---|---|
| **#3287** | P1 | **Split #3224's remaining 32.24% residual** — TMA level-2 + an offcore/prefetch breakdown. Also owns re-deriving the `4.6×` AC5 ceiling under the round-7 barrier fix (§6 caveat). Demoted from gating 2026-08-04: no funded lever currently depends on the residual split. |
