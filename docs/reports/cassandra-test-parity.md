...
- `cass.compaction.issue_899_per_element_collection_compaction` — Non-frozen collection elements reconcile by cell_path with no resurrection
  - Normalization: Per-element complex cells (column, cell_path, ts, ttl, ldt, is_deleted) are read back via the compaction KWayMerger and compared input-vs-output and across a two-input merge; element identity (pk, column, cell_path) must be unique in the merged output.
...
| `cass.compaction.CompactionSimpleValueMergeTest.static_row_merge` | required_parity | .github/workflows/compaction-parity.yml |
| `cass.compaction.GcCompactionTest.static_and_complex_columns_survive_gc` | required_parity | .github/workflows/compaction-parity.yml |
...
| `cass.compaction.issue_899_per_element_collection_compaction` | required_parity | .github/workflows/compaction-parity.yml |
...
| `cass.schema_evolution.issue_847_dropped_column_filter` | required_parity | .github/workflows/compaction-parity.yml |
| `cass.schema_evolution.issue_850_static_presence` | required_parity | .github/workflows/compaction-parity.yml |
...
| `cass.serialization.SerializationHeaderTest.static_and_dropped_columns` | required_parity | .github/workflows/compaction-parity.yml |
| `cass.serialization.SerializationMirrorTest.schema_evolution_ordering` | required_parity | .github/workflows/compaction-parity.yml |
...
| `cass.compaction.issue_899_per_element_collection_compaction` | nb | test-data/datasets/sstables/test_collections |
