...
- Distinct backing tests: **59** across **233** scenarios that name a test.
...
| `cqlite-core/tests/sstable_parity_filter_db_test.rs` | 5 |
...
| `cqlite-core/tests/sstable_parity_repaired_metadata_test.rs` | 4 |
| `cqlite-core/tests/issue_1190_write_load_byte_parity.rs` | 3 |
| `cqlite-core/tests/sstable_parity_integration_test.rs` | 3 |
...
| `cass.compression_info.fields.algorithm_name` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.fields.chunk_length` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.fields.chunk_offsets` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.fields.data_length` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.fields.max_compressed_length` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.fields.options` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compression_info.layout.no_crc_fields` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
...
| `cass.data_db.inline_crc.bad_trailer_rejected` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.data_db.inline_crc.incompressible_uncompressed_chunk` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.data_db.inline_crc.offset_delta_minus_crc_length` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.data_db.inline_crc.short_final_chunk` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.data_db.inline_crc.valid_trailer` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
...
| `cass.verify.component_presence` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.compression_info_parse` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.digest_crc32_match` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.full_row_scan` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.healthy_compressed_sstable` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.healthy_uncompressed_sstable` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.inline_crc_validation` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.verify.no_silent_empty_result_on_corruption` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
