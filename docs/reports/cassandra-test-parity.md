...
| `cass.compaction_merge.GcCompactionTest.row_cell_partition_tombstone_gc` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compaction_merge.byte_for_byte_output` | manual_debug | — |
| `cass.compaction_merge.issue_819.differential_input_merge_write_fidelity` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
| `cass.compaction_merge.issue_819.differential_row_tombstone_wide_partition_regression` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
...
| `cass.compaction_merge.tombstone_ttl_shadowing` | required_parity | .github/workflows/sstabledump-parity-gate.yml |
