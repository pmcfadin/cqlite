...
// Note: complex_data_test, sstable_benchmark, and sstable_validator were removed in Issue #176
// as they depended on SSTableWriter which is no longer available.
