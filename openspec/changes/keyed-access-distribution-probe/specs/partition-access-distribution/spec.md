...
- the **refusal conditions**, each of which yields *no answer* rather than a default verdict: a
  non-zero `unavailable` fraction, a non-census window at the sampling floor, a window below a stated
  minimum access count, and a window generated by synthetic or self-generated load;
