...
impl CassandraVersion {
    ...
    pub fn data_format(&self) -> DataFormat {
        match self {
            ...
            // V5_0DataFormat and test formats (C-G, Static Columns) use compressed 'nb' with legacy serialization
            ...
            | CassandraVersion::V5_0StaticColumns => DataFormat::V5CompressedLegacy,
