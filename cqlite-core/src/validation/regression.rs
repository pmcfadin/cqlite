...
impl RegressionTestSuite {
    ...
    pub fn save_baseline<P: AsRef<Path>>(&self, _path: P, _results: &[RegressionTestResult]) -> Result<()> {
...
pub fn generate_test_cases(_config: &crate::validation::ValidationConfig) -> Result<Vec<RegressionTestCase>> {
...
pub async fn run_test(test_case: &RegressionTestCase, _config: &crate::validation::ValidationConfig) -> Result<RegressionTestResult> {
