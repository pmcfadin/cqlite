        ...
        Ok(results) => {
            ...
            for (_dir_name, report) in &results {
                for analysis in &report.component_analysis {
                    ...
                    println!(
                        "   Required present: {} components",
                        analysis.required_components_present.len()
                    );
                    println!(
                        "   Required missing: {} components",
                        analysis.required_components_missing.len()
                    );
                    println!(
                        "   Optional present: {} components",
                        analysis.optional_components_present.len()
                    );
                    println!(
