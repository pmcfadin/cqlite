...
pub(super) const ANNOTATIONS: &[MetricDoc] = &[
    ...
    MetricDoc {
        ...
        kind: MetricKind::Counter,
        unit: catalog::unit::DIMENSIONLESS,
        summary: "Hits on the process-global key→partition-offset cache (a point read skips the Index.db interval parse / trie descent).",
        attributes: &[],
    ...
    MetricDoc {
        ...
        kind: MetricKind::Counter,
        unit: catalog::unit::DIMENSIONLESS,
        summary: "Misses on the global key cache (incl. fail-closed identity mismatch); each pays one interval parse / trie descent then populates.",
        attributes: &[],
    ...
    MetricDoc {
        ...
        kind: MetricKind::Counter,
        unit: catalog::unit::DIMENSIONLESS,
        summary: "Global key-cache entries evicted to stay within the byte budget (budget-driven; distinct from invalidations).",
        attributes: &[],
    ...
    MetricDoc {
        ...
        kind: MetricKind::Counter,
        unit: catalog::unit::DIMENSIONLESS,
        summary: "Global key-cache entries dropped on generation removal/compaction/warm-evict (distinct from budget evictions).",
        attributes: &[],
    ...
    MetricDoc {
        ...
        unit: catalog::unit::BYTES,
        summary: "Approximate resident footprint of the process-global key cache.",
        attributes: &[],
    ...
    MetricDoc {
        ...
        kind: MetricKind::Gauge,
        unit: catalog::unit::BYTES,
        summary: "The global key cache's fixed byte budget (0 when block caching is disabled).",
        attributes: &[],
