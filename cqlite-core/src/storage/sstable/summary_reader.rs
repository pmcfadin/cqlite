...
mod tests {
    ...
    fn test_complete_summary_parsing() {
        ...
        let mut data = vec![
            ...
            0xdc, 0x67, 0x26, 0xa6, 0x05, 0xc6, 0x48, 0x50, 0x86, 0xcd, 0x0f, 0xe3, 0x1b, 0x67,
            0x57, 0xaf, // key
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // position = 0
            // First key (20 bytes): be_u32(16) + 16 bytes
            0x00, 0x00, 0x00, 0x10, // size = 16
            0xdc, 0x67, 0x26, 0xa6, 0x05, 0xc6, 0x48, 0x50, 0x86, 0xcd, 0x0f, 0xe3, 0x1b, 0x67,
            0x57, 0xaf, // Last key (20 bytes): be_u32(16) + 16 bytes
            0x00, 0x00, 0x00, 0x10, // size = 16
            0xdc, 0x67, 0x26, 0xa6, 0x05, 0xc6, 0x48, 0x50, 0x86, 0xcd, 0x0f, 0xe3, 0x1b, 0x67,
            0x57, 0xaf,
        ];

        // Need to fix: the first/last key data was truncated in test construction
        // Rebuild properly
        data = vec![
            // Header (24 bytes)
            0x00, 0x00, 0x00, 0x80, // min_index_interval = 128
