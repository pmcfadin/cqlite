...
impl V5CompressedLegacyParser {
    ...
    ///
    /// `pub(super)` is #4106's, not this issue's: `cell_path_empty.rs` calls this
    /// from a SIBLING module (`daadfced3`), so the visibility must survive the
    /// peel removal — the rebase conflict here was visibility-vs-body, and both
    /// sides win their own half.
